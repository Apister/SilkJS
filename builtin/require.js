...
(function () {
    ...
    function locateFile(module) {
        ...
        throw 'Could not locate require file ' + module.toString();
    }
    ...
    require = function (module) {
        ...
        // What i need to do is convert the path from backslash \ to forward slash.
        modulePath = modulePath.slice(2, modulePath.length);
        modulePath = modulePath.replace(/\134/g, '/'); 
